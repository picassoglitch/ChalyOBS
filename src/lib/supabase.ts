 ...
 * project (`uqcbziwdgbnzehipzjxp.supabase.co`) that ChalybClip + the web app
 * use, so ChalybOBS is just another engine sitting on top of Chalyb's auth
 * and `profiles` table.
 *
...
/** Slug ChalybOBS uses in Chalyb's engines registry. */
